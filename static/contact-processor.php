...
$email_message .= "<p>You have just received an email from the address <a href=\"$current_host\" target=\"_blank\">$current_host</a> through the contact form.</p>";
$email_message .= "<p>Bellow you have the data in the contact form:</p>";
$email_message .= "<div>";
